...
SECRET_KEY = 'django-insecure-6+8c^#oo*cpc&o5p3szjan7jg155&20w%2kdxx#rm!_&0&rd1v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # This will point to the 'templates' folder in the root directory
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
